...
// cards.forEach((card) => {
//   var gif, thumb;
//   card.querySelector(".thumb").addEventListener("mouseover", () => {
//     gif = card.querySelector(".thumb img").getAttribute("preview");
//     thumb = card.querySelector(".thumb img").getAttribute("src");
//     card.querySelector(".thumb img").setAttribute("src", gif);
//   });
//   card.querySelector(".thumb").addEventListener("mouseout", () => {
//     card.querySelector(".thumb img").setAttribute("src", thumb);
//   });
// });
